...
| PORT-17 | P1: Priority Cases | Execute | In Progress (T12 complete) |
| PORT-18 | P1: Priority Cases | Execute | In Progress (T12 complete) |
| PORT-19 | P1: Priority Cases | Execute | In Progress (T12 complete) |
| PORT-20 | P1: Priority Cases | Execute | In Progress (T12 complete) |
| PORT-21 | P1: Priority Cases | Execute | In Progress (T12 complete) |
| PORT-22 | P1: Priority Cases | Execute | In Progress (T12 complete) |
| PORT-23 | P1: Editorial Integrity | Execute | In Progress (T12 complete) |
...
| PORT-39 | P1: Bilingual Experience | Execute | In Progress (T12 complete) |
...
| PORT-47 | P1: Responsive Accessibility | Execute | In Progress (T12 complete) |
